...
import com.dubbo.req.user.LocationUpdateReq;
import com.dubbo.req.user.RoleMenuReq;
import com.dubbo.req.user.RolePermissionReq;
import com.dubbo.req.user.UserQueryReq;
