package com.dubbo.order.init;

import com.dubbo.enmu.order.ProcessReqEnum;
import com.dubbo.order.annotation.InjectProcessors;
import com.dubbo.order.annotation.PackageScan;
import com.dubbo.order.engine.ProcessEngine;
import com.dubbo.order.processor.Processor;
 ...
 */
@Component
@PackageScan("com.dubbo.order.engine.ProcessEngine")
